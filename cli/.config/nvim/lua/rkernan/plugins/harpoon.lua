...
return {
  ...
  keys = {
    ...
    -- prev/next harpoon
    { ']h', function () require('harpoon'):list():next({ ui_nav_wrap = true }) end, desc = 'Harpoon next' },
    { '[h', function () require('harpoon'):list():prev({ ui_nav_wrap = true }) end, desc = 'Harpoon prev' },
  },
  config = true,
}
