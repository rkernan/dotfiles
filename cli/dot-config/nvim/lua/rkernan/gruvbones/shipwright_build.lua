...
local colorschemes = require('rkernan.gruvbones.palette')
local specs_name = 'gruvbones'

for _, bg in pairs({ 'dark', 'light' }) do
  local term = colorschemes[bg].termcolors
  --- @diagnostic disable: undefined-global
  run(colorschemes[bg].specs, lushwright.to_vimscript, function(colors)
    local termcolors = {
  ...
  end, { prepend, [[" This codeblock is auto-generate by shipwright.nvim ]] }, {
