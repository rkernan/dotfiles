...
call s:hl('ModestatusYellow', s:yellow, s:bg2, 'none')
call s:hl('ModestatusPurple', s:purple, s:bg2, 'none')
call s:hl('ModestatusAqua', s:aqua, s:bg2, 'none')
...
call s:hl('ModestatusNCPurple', s:purple, s:bg1, 'none')
call s:hl('ModestatusNCAqua', s:aqua, s:bg1, 'none')
